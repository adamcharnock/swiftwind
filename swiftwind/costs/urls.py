...
urlpatterns = [
    ...
    url(r'^recurring/unarchive/(?P<uuid>.+)/$', views.UnarchiveRecurringCostView.as_view(), name='unarchive_recurring'),
    url(r'^oneoff/unarchive/(?P<uuid>.+)/$', views.UnarchiveOneOffCostView.as_view(), name='unarchive_one_off'),
]
